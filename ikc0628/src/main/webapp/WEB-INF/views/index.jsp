        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                      ...
                      <!-- <li><input type="button" onclick="linepay()" value ="linepay"> -->  
            ...
            function linepay(){
            	var data={
            			...
            			"productName": "ithome",
            			"productImageUrl": "",
            			"confirmUrl":"http://localhost:8080/",
            			"orderId": "1111111231323333323qwd22qdq",
            			"currency": "TWD"	
            			}
            	var xhr =new XMLHttpRequest();
            	xhr.open('post',"https://sandbox-api-pay.line.me/v2/payments/request",true);
            	xhr.setRequestHeader('Access-Control-Allow-Origin','http://web.com.tw')
            	xhr.setRequestHeader('Content-Type','application/json');
            	xhr.setRequestHeader('X-LINE-ChannelId','1657234235');
            	xhr.setRequestHeader('X-LINE-ChannelSecret','5f098b48a13fe6353a517e9300f503dc');
            	
            	var payment = JSON.stringify(data);
            	xhr.send(payment);
            }
